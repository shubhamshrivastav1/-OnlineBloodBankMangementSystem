<%-- 
    Document   : rhospital
    Created on : 21 Mar, 2021, 6:51:41 PM
    Author     : Shubham
--%>
            ...
            <div align="center">
                ...
                <form action="Hregister" method="post">
                    <table style="with: 100%">
                        ...
                        <tr>
                            <td>Hospital ID &nbsp;:&nbsp;</td>
                            <td><input type="text" name="hospitalID" class="form-control" value=<% out.println(first); %> size="10" readonly required></td>
                            <td>Hospital Name &nbsp;:&nbsp;</td>
                            <td><input type="text" name="hname" placeholder="Hospital Name" maxlength="30" class="form-control" autofocus required></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="date" name="trdate" class="form-control" required></td>
                        </tr>
    
                        <tr>
                            <td>Contact No &nbsp;:&nbsp;</td>
                            <td><input type="number" name="mobile" placeholder="Hospital Contact Number" maxlength="10" alt="Contact Number" size="10" class="form-control" required></td>
                            <td>Email &nbsp;:&nbsp;</td>
