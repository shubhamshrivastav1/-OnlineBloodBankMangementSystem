<%-- 
    Document   : uregister
    Created on : 21 Mar, 2021, 7:17:27 PM
    Author     : Shubham
--%>
            ...
            <div align="center">
                ...
                <form action="Ureg.jsp" method="post">
                    <table style="with: 100%">
                        ...
                        <tr>
                            <td>Mobile No &nbsp;:&nbsp;</td>
                            <td><input type="number" name="mobile" placeholder="Mobile Number" maxlength="10" alt="Contact Number" size="10" class="form-control" required></td>
                            <td>Email &nbsp;:&nbsp;</td>
                        ...
                        <tr>
                            <td>Doner ID &nbsp;:&nbsp;</td>
                            <td><input type="text" name="donerID" class="form-control" value=<% out.println(first); %> size="10" readonly required></td>
                            <td></td>
                            <td>
                            </td>
                        </tr>
