<%-- 
    ...
    Created on : 20 Mar, 2021, 1:50:55 PM
    Author     : Shubham
--%>
...
<h1 align="center" style="color:green;">Registration successful go for login
    
    
    <a href="login.jsp"  style="margin-left: 80px; size: 100px; font-size:25px; font-weight:900;">Login</a>
