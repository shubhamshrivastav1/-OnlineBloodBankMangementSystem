<%-- 
    Document   : bloodbank
    Created on : 20 Mar, 2021, 1:59:34 PM
    Author     : Shubham
--%>
        ...
        <div id="tooplate_body_wrapper">
            ...
            <div id="tooplate_middle_subpage">
                ...
                <form action="searchdoner.jsp" method="post">
                   ...
                   Location  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type="text" name="loc" placeholder="location"/>
                   <br><br>
                    <input type="submit" value="Search" class="btn btn-primary active" style="background:#30122b;
