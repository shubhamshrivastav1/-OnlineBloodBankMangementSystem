...
public class Bregister extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Bregister</title>");            
            out.println("</head>");
            out.println("<body>");
            
            String bid=request.getParameter("bloodBankID");
            ...
            String query="insert into bregister(bid,bname,bld,contact,email,address,password)values(?,?,?,?,?,?,?)";
